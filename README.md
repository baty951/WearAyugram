...
- **Сообщения**:
  ...
  - видео и кружочки — превью с кадром, полноэкранный плеер (VideoView)
...
- Анимированные стикеры (TGS/WEBM) показываются статичным кадром, GIF — текстовым плейсхолдером
- Реакции, реплаи, пересылка, история редактирований — не реализованы
